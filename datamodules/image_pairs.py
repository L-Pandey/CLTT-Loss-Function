...
''''
For a batch of size N, the dataloader will return:
First Image: The first image in each temporal window for all N samples.
Second Image: The second image in each temporal window for all N samples.
Third Image: The third image in each temporal window for all N samples.
'''
...
class ImagePairs(VisionDataset): # Dataset can also be used as a parent class
    ...
    Args:
        ...
        window_size: Size of sliding window for sampling pairs. If the window_size
            ...
            within the sliding time window. NOTE: USE A WINDOW SIZE OF 3!! CODE NOT OPTIMIZED FOR OTHER SIZES
    """
    def __init__(
        self,
        root: str,
    ...
    def _make_pairs(self) -> List[Tuple[str, str]]:
        ...
        'train1_x.png' [UT AUSTIN DATASET] ||
        '''
